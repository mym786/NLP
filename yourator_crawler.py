...
for i in range(0,data_row):
    ...
    sql = "INSERT INTO yourator_job (companyName, positionURL, positionTitle, positionContent) VALUES ('{}','{}','{}','{}')"\
    .format(com_title_list[i],job_url_list[i],job_name_list[i],job_content_list[i])
    print(sql)
